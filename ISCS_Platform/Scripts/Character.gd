...
@onready var water_in_sfx: AudioStreamPlayer2D = $WaterInSFX
@onready var mud_in_sfx: AudioStreamPlayer2D = $MudInSFX
...
func _physics_process(delta):
	...
	if (on_ground or on_mud) and is_water:
		water_in_sfx.play()
